...
void FieldMap::populateStandardField() {
    ...
    struct Entry { const char *name; double x1,y1,x2,y2,long_cm,short_cm,margin; } entries[] = {
        ...
        {"MLB1", 183.0, 120.0, 164.0, 120.0, 19.0, 16.0, 2.0},
        {"MLB2", 183.0, -120.0, 164.0, -120.0, 19.0, 16.0, 2.0},
        {"MLR1", -183.0, 120.0, -164.0, 120.0, 19.0, 16.0, 2.0},
        {"MLR2", -183.0, -120.0, -164.0, -120.0, 19.0, 16.0, 2.0},
